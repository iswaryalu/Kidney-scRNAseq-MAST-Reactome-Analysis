...
for (i in seq_along(deg_files)) {
  ...
  celltype <- sub("^DEG_(.*?)_HCKD_vs_Normal\\.csv$", "\\1", file_name)
...
combined_out <- file.path(deg_path, "All_CellTypes_Reactome_ORA_HCKD_vs_Normal.csv")
